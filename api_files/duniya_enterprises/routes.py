...
from api_files.utils import duniyaenterprises_db
from bson.objectid import ObjectId
from datetime import datetime,timedelta
from zoneinfo import ZoneInfo
from api_files.duniya_enterprises.staff import staff_bp
from api_files.duniya_enterprises.trade import trade_bp
from api_files.duniya_enterprises.awsfile import aws_bp

duniya_enterprises = Blueprint("duniya_enterprises", __name__)





duniya_enterprises.register_blueprint(staff_bp, url_prefix="/staff")
duniya_enterprises.register_blueprint(trade_bp, url_prefix="/trade")
duniya_enterprises.register_blueprint(aws_bp, url_prefix="/aws")

vouchers = duniyaenterprises_db["vouchers"] 
groups_collection = duniyaenterprises_db["groups"] 
subgroups_collection = duniyaenterprises_db["subgroups"] 
ledgers_collection = duniyaenterprises_db["ledgers"] 


@duniya_enterprises.route("/payment_voucher", methods=["POST"])
def payment_voucher():
    try:
        data = request.json
...
@duniya_enterprises.route("/receipt_voucher", methods=["POST"])
def receipt_voucher():
    try:
        data = request.json
...
@duniya_enterprises.route("/journal_voucher", methods=["POST"])
def journal_voucher():
    try:
        data = request.json
...
@duniya_enterprises.route("/v1/vouchers", methods=["GET"])
...
@duniya_enterprises.route('/v1/ledger/<ledger_id>', methods=['GET'])
...
@duniya_enterprises.route('/v1/ledger2/<ledger_id>/<emp_name>', methods=['GET'])
...
# ------------------ GROUPS ------------------
@duniya_enterprises.route("/groups", methods=["POST"])
...
@duniya_enterprises.route("/groups", methods=["GET"])
def get_all_groups():
    try:
...
@duniya_enterprises.route("/subgroups", methods=["POST"])
...
@duniya_enterprises.route("/subgroups", methods=["GET"])
...
# ------------------ LEDGERS ------------------
@duniya_enterprises.route("/ledgers", methods=["POST"])
...
@duniya_enterprises.route("/ledgers", methods=["GET"])
def get_all_ledgers():
    try:
        pipeline = [
            {
...
@duniya_enterprises.route("/v1/financial-report", methods=["GET"])
...
@duniya_enterprises.route("/v1/financial-report-trading", methods=["GET"])
...
def get_closing_stock():
    try:
        ...
        # =========================
        vouchers = list(
            duniyaenterprises_db.vouchers.find(
                {"data": {"$exists": True}},
                {"data.items": 1, "date": 1}
            )
        )
        ...
        # =========================
        bills = list(
            duniyaenterprises_db.bills.find(
                {},
                {"items": 1}
            )
        )
...
@duniya_enterprises.route("/v1/financial-report-trial-balance", methods=["GET"])
